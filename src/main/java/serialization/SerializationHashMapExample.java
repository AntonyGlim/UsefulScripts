...
/**
 * In this class we do Serialization to HashMap
 */

public class SerializationHashMapExample<E> extends AbstractSet<E> implements Serializable, Cloneable, Set<E> {
    ...
    public SerializationHashMapExample() {
        this.map = new HashMap<>();
    }

    public SerializationHashMapExample(Collection<? extends E> collection) {
    ...
    public Object clone() throws CloneNotSupportedException, InternalError {
        try {
            SerializationHashMapExample copy = (SerializationHashMapExample)super.clone();
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException { //TODO DELETE THIS
        ...
        SerializationHashMapExample<String> stringAmigoSet = new SerializationHashMapExample<>();
        ...
        SerializationHashMapExample stringAmigoSetCopy = (SerializationHashMapExample) objectInputStream.readObject();
